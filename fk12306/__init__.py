...
@click.option("-z", "--zmode", default=False, is_flag=True, help="高级模式")
@click.option("-zz", "--zzmode", default=False, is_flag=True, help="终极模式")
...
def main(
    ...
    """
        12306查票助手
        Example：fk12306 -f 上海 -t 北京 -d "2019-02-10" -n "G16 G18 G22" -z
    """
    opts = Options()
